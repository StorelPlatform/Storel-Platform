...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Storel related functionality
...
/*
    ...
    allow endless transaction that would bloat Storel and make it unusable. To
