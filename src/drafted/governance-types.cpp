...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "StorelNetwork") type = StorelNetwork;
    if(strType == "StorelNetworkVariable") type = StorelNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == StorelNetwork) s = "StorelNetwork";
    if(type == StorelNetworkVariable) s = "StorelNetworkVariable";
