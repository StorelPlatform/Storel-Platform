 ...
 *
 *   // network
 *   CStorelNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.storel.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CStorelNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: StorelNetwork
// //   -- signature requirements : Key1(User)
// class CStorelNetworkVariable : public CGovernanceObject
// {
// private:
