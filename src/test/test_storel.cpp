...
#define BOOST_TEST_MODULE Storel Test Suite

#include "test_storel.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_storel_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
