    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STOREL-light"), QVariant("light"));
    ui->theme->addItem(QString("STOREL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("STOREL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STOREL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STOREL-traditional"), QVariant("trad"));
