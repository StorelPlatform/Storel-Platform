    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Storel Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Storel Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  storel-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Storel in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 STOREL, 0.1 STOREL, 1 STOREL and 10 STOREL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://storelpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://storelpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Storel Core is shutting down...") + "<br /><br />" +
