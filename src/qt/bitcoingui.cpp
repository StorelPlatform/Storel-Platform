    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Storel Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Storel address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and storel: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Storel Core"), this);
    aboutAction->setStatusTip(tr("Show information about Storel Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Storel Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Storel addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Storel addresses"));
    ...
    openAction->setStatusTip(tr("Open a storel: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Storel Core help message to get a list with possible Storel Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Storel Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Storel network", "", count));
    } else {
...
{
    QString strTitle = tr("Storel Core"); // default title
