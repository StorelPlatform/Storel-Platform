...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Storel Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  storel-cli [options] <command> [params]  " + _("Send command to Storel Core") + "\n" +
                  "  storel-cli [options] help                " + _("List commands") + "\n" +
                  "  storel-cli [options] help <command>      " + _("Get help for a command") + "\n";
