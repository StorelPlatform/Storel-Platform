...
Only requiring some minor changes is storel.cpp.
...
Changes to storel.cpp
----------------------
storel.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
